...
export const PROJECTS = [
  ...
  },
  {
    ...
    tag: "ML · NLP",
    metric: "96%",
    name: "Harm Score Predictor",
    desc: "A machine learning and NLP model that detects hidden harmful intent in text, even sentences with no explicit slurs. Trained on 7000+ labelled records and presented to stakeholders at RMIT.",
    stack: ["Python", "XGBoost", "NLP", "Scikit-learn"],
    link: { href: "https://rmit-arc.instructuremedia.com/embed/269fc476-53de-4a74-851b-6377b7dd465b", label: "Watch the demo" },
  },
  {
    feat: false,
    render: "triage",
  ...
  },
  {
    ...
    render: "classify",
    tag: "NLP · ML",
    metric: "Auto-classify",
    name: "NLP Job Matching Platform",
    desc: "A system that reads job ads and classifies them into the correct category automatically, fixing employer mis-tagging. Built with text preprocessing, Word2Vec / FastText embeddings and logistic regression.",
    stack: ["NLP", "Word2Vec", "FastText", "R"],
    link: null,
  },
  {
    feat: false,
